...
function Userloantracker(){
  ...
  return(
        <>
          <div className="dash-table mt-3 mx-3 p-2">
        ...
        {currentData && currentData.length > 0 ? (
            currentData.map((loan) => (
              <tr key={loan.userpropid}>
                ...
                <td className='dash-table-text1' style={{height:"45px",color:"#06152B",paddingTop:"13px"}}>{loan.propertyaddress1}</td>
                <td className='dash-table-text1' style={{height:"45px",color:"#06152B",paddingTop:"13px"}}>{loan.purchaseprice}</td>
                ...
                <td className='dash-table-text1' style={{height:"45px",color:"#06152B",paddingTop:"13px"}}>{loan.term}</td>
                <td className='dash-table-text1' style={{height:"45px",color:"#06152B",paddingTop:"13px"}}><a href='#'>Message LO</a><br/>
...
export default Userloantracker;