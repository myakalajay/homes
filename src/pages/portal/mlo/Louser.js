...
import axios from "axios";
 ...
 function Louser(){
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                ...
                setLoUserData(user); // Directly set the fetched data to profileData state
    ...
    // console.log("zip",zip,options,louserData.zipcode)
...
const getModifiedPayload = () =>{
        ...
        const handleSubmitUser = async () => {
            try {
                const response = await fetch(`${process.env.NEXT_PUBLIC_SITE_URL}/setloprofile`, {
                    ...
                    // body: JSON.stringify(louserData),
    ...
    return(
        <>
        <div className="dash-table1 row p-3">
                        ...
                        <div className="col-md-4 col-sm-12 mt-2">
                                      ...
                                      <div className="m-1">
                                        <input 
                                            ...
                                            // checked={louserData.nmls === 1}
                                            // onChange={(e) => handleNmlsAllowedChange(e.target.value)}
                                            onChange={handleUserChange}
                                        />
